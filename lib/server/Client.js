...
//   this.emit(CLIENT_EVENTS.ready, null);
}
...
Client.prototype.addWorkspace = function(workspace) {
   ...
   updateWorkspaceInModel(this);
   this.socket.emit(SOCKET_EVENTS.workspaceUpdate)
};
...
Client.prototype.removeWorkspace = function(workspace) {
      _.remove(this.workspace, workspace);
   updateWorkspaceInModel(this);
   this.socket.emit(SOCKET_EVENTS.workspaceUpdate)
};
